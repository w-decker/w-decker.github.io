...
<center>
  <a href="https://github.com/w-decker/hidden-markov-model">
    <img src="images/intro_weather.png" alt="HMM" width="120" height="100" class="HMM"/>
  </a>
</center>

What is a hidden Markov model (HMM)? How is it used in cognitive neuroscience? Here I provide an understanding of the concepts underlying HMMs, HMMs in general, and relevant literature that makes use of Markovian processes. Click on the image below to learn more about HMMs! An effort to make t

## Building MATLAB Functions

<center>
  <a href="https://github.com/w-decker/matlab-funcs">
