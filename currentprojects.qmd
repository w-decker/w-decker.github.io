...
Below are brief synopses of current projects that I am working on. Of course, there are a multitude of other projects at various stages which I am a part of; however, the following descriptions are from projects which are developed and directed by me and I felt added to the characterization of my science and research interests.

---

## The Architecture of Auditory Statistical Learning

Statistical learning (SL) is the neurocognitive mechanism that the brain employs to identify, parse and extract meaning from continuous input via statistical computations such as transitional probabilites (TPs) and/or chunking. SL can be observed across a variety of cognitive domains and is particularly relevant in the language domain. It has been shown that langauge acquisition occurs through SL. However, previous neuroimaging studies characterize the learning of meaning via auditory SL as static when, rather, learning occurs across the temporal domain, employing various neural regions across space. The focus of this current project is to idetify the changes in functional "states" _during_ SL to uncover how changes in learning are supported at the neural level. To do this, we can use fMRI and a sliding window correlation analysis (detailed by [Vergara et al. (2019)](https://onlinelibrary.wiley.com/doi/epdf/10.1002/hbm.24509)). The code for this is currently being developed and can be found [here](https://github.com/w-decker/average_sliding_window) on my GitHub. As of yet, the project is still being constructed.
